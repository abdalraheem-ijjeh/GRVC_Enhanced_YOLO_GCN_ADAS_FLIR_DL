...
Description:
    This script is used to fine-tune the SSD MobileNet v2 FPNLite model using TensorFlow Object Detection API used for
...
# Paths
MODEL_DIR = "Comparative_models/models_/tf_models_architectures/ssd_mobilenet_v2_fpnlite"
PIPELINE_CONFIG_PATH = "pipeline.config"
OUTPUT_DIR = "Comparative_models/models_/tf_models_architectures/ssd_mobilenet_v2_fpnlite/checkpoint"
