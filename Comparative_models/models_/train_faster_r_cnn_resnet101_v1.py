...
Description:
    This script is used to fine-tune the Faster R-CNN ResNet101 V1 model using TensorFlow Object Detection API used for
...
Usage:
    ...
    ```
    python train_faster_r_cnn_resnet101_v1.py
    ```
...
# Paths
MODEL_DIR = "Comparative_models/models_/tf_models_architectures/faster_rcnn_resnet101_v1"
PIPELINE_CONFIG_PATH = "pipeline.config"
OUTPUT_DIR = "Comparative_models/models_/tf_models_architectures/faster_rcnn_resnet101_v1/checkpoint"
